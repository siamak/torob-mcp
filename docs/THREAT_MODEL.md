...
| A3  | **The MCP client's context window**  | Everything we return is read by a model that may hold credentials, repo contents, and tool-calling authority. Text we emit is _instructions_ to something powerful. |
...
- **B1 — client → us.** Tool arguments. The model is not hostile, but it is _steerable_: it may
...
### T1 — SSRF via tool arguments _(B1→B2, assets A1 A2)_
...
### T2 — Prompt injection via listing content _(B4→B3, asset A3)_ — **highest severity**
...
### T3 — DNS rebinding against HTTP mode _(B1, assets A1 A4)_
...
### T4 — Abuse of an exposed HTTP server _(B1, assets A4 A2)_
...
- Phase 5 tightens this — Worker auth is _always_ required, never optional.

### T5 — Dependency / supply-chain compromise _(A5, A1)_
...
### T6 — Resource exhaustion _(A1, A4)_
...
### T7 — Leaking third parties' private data _(A3, A6)_ — **specific to this codebase**
...
### T8 — Privacy of the user's queries _(A6, B5)_
...
### T9 — Upstream schema drift mistaken for data _(B4, A3)_
...
### T10 — Being blocked, and failing unsafely _(A4)_
