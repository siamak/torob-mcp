...
[Docs index](docs/README.md) · [Architecture](docs/ARCHITECTURE.md) · [Endpoints](docs/ENDPOINTS.md)
...
- **No new runtime dependency** without a justification in [`docs/DEPENDENCIES.md`](docs/DEPENDENCIES.md).
...
1. [`docs/ENDPOINTS.md`](docs/ENDPOINTS.md) — the URL, params, field map, and any new gotcha.
...
Keep them focused, explain the why in the description, and fill in the
[security checklist](.github/pull_request_template.md). CI runs lint, typecheck, tests with coverage
gates (90% lines / 85% branches), build, e2e, audit, CodeQL and gitleaks.
